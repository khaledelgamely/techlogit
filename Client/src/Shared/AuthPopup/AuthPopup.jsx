...
const AuthPopup = ({ onClose }) => {
  ...
  const handleSubmit = async (values) => {
    setLoading(true);
    try {
      const { data } = await Tech_Logit.post("auth/signin", values);
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center z-50 bg-[#000000b0]">
      <div
      ...
      >
        ...
        <div className="flex items-center justify-center xs:w-[80vw] md:w-[40vw] min-h-[70vh]">
          <Formik
          ...
          >
            {(formik) => (
              <Form className="xs:w-11/12 md:w-11/12 lg:w-10/12">
                <h1 className="my-2 text-[30px] md:text-4xl text-center text-[#1b75bc] font-semibold">
                  Hello Again
                </h1>
                <p className=" text-lg md:text-lg mb-5 font-normal text-center text-neutral-700 ">
